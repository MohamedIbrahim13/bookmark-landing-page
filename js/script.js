...
iconOpen.addEventListener('click', (e) => {
    ...
    logo.innerHTML = `<svg width="148" height="25" xmlns="http://www.w3.org/2000/svg">
                    <g fill="none" fill-rule="evenodd">
                        ...
                        <g>
                            ...
                            <path d="M9 9v10l3.54-3.44L16.078 19V9a2 2 0 0 0-2-2H11a2 2 0 0 0-2 2z" fill="hsl(229, 31%, 21%)" />
                        </g>
                    </g>
                </svg>`;
...
iconClose.addEventListener('click', (e) => {
    ...
    logo.innerHTML = `<img src="images/logo-bookmark.svg" alt="Bookmark Logo">`;
...
$(document).ready(function () {
    const questions = $('.faq .container .row #question');
    const arrows = $('.faq .container .row #question .d-flex .arrow');
    const svgs = $('.faq .container .row #question .d-flex .arrow svg');

    questions.on('click', function () {
        $(this).find('#answer').slideToggle(500);
        $(this).find('.arrow').addClass('rotate').find('svg').css({
            "stroke": "hsl(0, 94%, 66%) !important",
            "margin-top": "-20px"
        });
...
registerForm.addEventListener('submit', (e) => {
    ...
    if (!registerForm.email.value) {
        ...
        input.style.borderColor = "hsl(231, 69%, 60%)";
        errorIcon.classList.remove('d-none');

    };
    if (!emailIsValid(registerForm.email.value)) {
        errorText.classList.remove('d-none');
        input.style.border = 'solid 2px hsl(0, 94%, 66%)';
        errorIcon.classList.remove('d-none');
    };
